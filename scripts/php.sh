...
# Install PHP
#mv /etc/php5/fpm/php.ini.ucf-dist /etc/php5/fpm/php.ini
sudo apt-get purge --force-yes -y php5-cli php5-fpm
sudo apt-get install --force-yes -y php5-cli php5-fpm php5-mysql php5-pgsql php5-sqlite php5-curl php5-gd php5-gmp php5-mcrypt php5-xdebug php5-memcached php5-imagick
